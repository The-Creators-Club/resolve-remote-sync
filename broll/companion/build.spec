# PyInstaller spec for "BRoll Companion".
#
# Produces a single-file executable per OS. Build separately on each target
# OS (PyInstaller does not cross-compile) — see BUILD.md for the commands.
#
# Usage:
...
# pystray/Pillow are optional at runtime (see src/broll_companion/tray.py);
...
entry_point = str(Path("src") / "broll_companion" / "__main__.py")
