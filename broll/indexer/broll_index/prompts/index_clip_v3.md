...
> ✓ "Dashcam view through a windscreen on an elevated urban expressway. The car
> directly ahead has its brake lights lit; several lanes of slow-moving traffic,
> guardrail and apartment blocks either side."
...
**Uncertainty is fine — state it.** "A woman handling what appears to be melons"
is a good description. "Officials at a microphone, possibly a government press
conference" is good. Hedged uncertainty is honest and useful; confident
invention is not. When you cannot identify something, describe how it looks
