// The terminal look's copy of copy_value.js (UI port 2.1, phase 0). Same
// behaviour, unbracketed labels; loaded only by cc/ templates, never beside the
// classic file (two delegated handlers would both run). Classic original:
// "Copy" for the values an admin has to transcribe (DUI-1, 2026-09-04).
//
...
(function () {
  ...
  // click inside the 2 s window saved the copied label as the label to go back
